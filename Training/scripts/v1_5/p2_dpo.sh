...
gpu_vis=2,5 # Change this to the GPUs you want to use, e.g., 0,1,2 for 3 GPUs

MODEL_PATH="/data/base_model/base_models_mllms/llava-v1.5-13b"
REF_MODEL_PATH="/data/base_model/base_models_mllms/llava-v1.5-13b"
...
deepspeed --include localhost:$gpu_vis --master_port $MASTER_PORT \
    ...
    --lora_dropout 0.05 \
    --scale_coeff 0.1 \
    --data_path /data/ruipeng.zhang/dpo_on/RLHF_mix_fix_dl_13vcd_clipscore.json \
